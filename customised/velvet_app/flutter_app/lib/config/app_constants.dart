class AppConstants {
  ...
  static String messageStatusPath(String messageId) =>
      '/api/messagegatewayapi/message-status/$messageId';
  static String notificationDeliveryPath(String id) =>
      '/api/notifications/$id/delivery';
