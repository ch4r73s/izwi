...
public class NotificationService : INotificationService
{
    ...
    public async Task<Notification> CreateForUserAsync(string userId, string title, string message, string type, string? referenceId, string? createdByUserId, string deliveryStatus = "Sent", string? errorDetails = null, string? recipientsSummary = null, IEnumerable<NotificationRecipientInput>? recipients = null)
    {
        ...
        if (recipients != null)
        {
            var rows = recipients.Select(r => new NotificationRecipient
            {
            ...
            await _context.NotificationRecipients.AddRangeAsync(rows);
            await _context.SaveChangesAsync();
        }
    ...
    public async Task<IReadOnlyList<Notification>> CreateForUsersAsync(IEnumerable<string> userIds, string title, string message, string type, string? referenceId, string? createdByUserId, string deliveryStatus = "Sent", string? errorDetails = null, string? recipientsSummary = null, IEnumerable<NotificationRecipientInput>? recipients = null)
    {
        ...
        if (recipients != null)
        {
            ...
            var rows = notifications.SelectMany(n => recipientList.Select(r => new NotificationRecipient
            {
                NotificationId = n.Id,
                Name = r.Name,
                PhoneNumber = r.PhoneNumber,
